...
LOCK TABLES `wp_sieconsgf_entry_notes` WRITE;
/*!40000 ALTER TABLE `wp_sieconsgf_entry_notes` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_sieconsgf_entry_notes` ENABLE KEYS */;
UNLOCK TABLES;
