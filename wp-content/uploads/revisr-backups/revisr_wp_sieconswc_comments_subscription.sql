...
LOCK TABLES `wp_sieconswc_comments_subscription` WRITE;
/*!40000 ALTER TABLE `wp_sieconswc_comments_subscription` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_sieconswc_comments_subscription` ENABLE KEYS */;
UNLOCK TABLES;
