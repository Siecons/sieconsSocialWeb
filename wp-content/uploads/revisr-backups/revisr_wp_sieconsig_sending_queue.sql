...
LOCK TABLES `wp_sieconsig_sending_queue` WRITE;
/*!40000 ALTER TABLE `wp_sieconsig_sending_queue` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_sieconsig_sending_queue` ENABLE KEYS */;
UNLOCK TABLES;
