...
LOCK TABLES `wp_sieconsig_mailing_queue` WRITE;
/*!40000 ALTER TABLE `wp_sieconsig_mailing_queue` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_sieconsig_mailing_queue` ENABLE KEYS */;
UNLOCK TABLES;
