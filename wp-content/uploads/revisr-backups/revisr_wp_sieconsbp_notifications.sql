...
LOCK TABLES `wp_sieconsbp_notifications` WRITE;
/*!40000 ALTER TABLE `wp_sieconsbp_notifications` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_sieconsbp_notifications` ENABLE KEYS */;
UNLOCK TABLES;
