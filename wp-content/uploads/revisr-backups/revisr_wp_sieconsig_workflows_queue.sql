...
LOCK TABLES `wp_sieconsig_workflows_queue` WRITE;
/*!40000 ALTER TABLE `wp_sieconsig_workflows_queue` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_sieconsig_workflows_queue` ENABLE KEYS */;
UNLOCK TABLES;
