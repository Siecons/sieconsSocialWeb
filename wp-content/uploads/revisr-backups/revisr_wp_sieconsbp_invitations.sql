...
LOCK TABLES `wp_sieconsbp_invitations` WRITE;
/*!40000 ALTER TABLE `wp_sieconsbp_invitations` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_sieconsbp_invitations` ENABLE KEYS */;
UNLOCK TABLES;
